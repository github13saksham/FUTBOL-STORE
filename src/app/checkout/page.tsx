...
export default function CheckoutPage() {
  ...
  const handlePayment = async () => {
    ...
    try {
      const sdkLoaded = await initializeCashfree();
      if (!sdkLoaded) {
      ...
      const finalDate = new Date().toLocaleString('en-IN', { timeZone: 'Asia/Kolkata', dateStyle: 'short', timeStyle: 'short' });
      ...
      cashfree.checkout(checkoutOptions).then(async (result: any) => {
          ...
          try {
            ...
            if (verifyRes.message === "Payment verified successfully") {
              ...
              try {
                ...
                createdOrderId = await dbService.confirmOrder(data.id, verifyRes.paymentId || "UNKNOWN");
        ...
        try {
          ...
          console.error("Failed to delete pending order on error", e);
        }
            ...
            <section className="space-y-4 pt-4 border-t border-white/10">
              ...
              <div className="bg-[#141414] p-5 border border-white/10 rounded-xl space-y-3">
                <p className="text-xs text-white/70 font-sans font-light leading-relaxed">
                  All transactions are secure and encrypted. Payments are processed securely via <span className="font-semibold text-white">Cashfree</span>.
                </p>
                <div className="flex flex-col gap-3">
                  ...
                  <div className="flex gap-3 opacity-70 border-t border-white/10 pt-3 mt-1">
                    ...
                    <div className="flex flex-col">
                      <span className="text-[11px] font-semibold text-white">Cashfree Secure Checkout</span>
